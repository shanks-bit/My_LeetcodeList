...
class Solution {
    ...
    private TreeNode solve(int[] inorder, int[] postorder, int inStart, int inEnd, 
        ...
        root.left =  solve(inorder, postorder, inStart, i-1, postStart, postStart
                    +leftSize-1);
        root.right = solve(inorder, postorder, i+1, inEnd, postEnd-rightSize ,
                    postEnd-1);            
