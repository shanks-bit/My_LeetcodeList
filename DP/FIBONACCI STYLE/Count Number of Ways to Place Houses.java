...
// we are multiplying ans to get for both sides and on one side it will act as a fibbonocci seriess and 
// whenever no 2 adjacent elements can be choosen uses.
class Solution {
    long m = 1000000007;
    long[] dp;
